! function(e, t) {
    ...
    function O(e, t, n) {
        var r, i, o = 0,
            ...
            l = function() {
                if (i) return !1;
                for (var t = hn || H(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(o);
    ...
    var ut = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : B) !== _ && L(t), t = t || _, n = n || [], !e || "string" != typeof e) return n;
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, l, u) {
                    var c, d, f, p = 0,
                        ...
                        w = b.length;
                    for (u && (j = a !== _ && a); h !== w && null != (c = b[h]); h++) {
                        if (o && c) {
                            for (d = 0; f = e[d++];)
                                if (f(c, a, s)) {
                                    l.push(c);
        ...
        var x, w, T, k, C, E, N, S, j, A, D, L, _, H, q, F, M, $, O, R = "sizzle" + -new Date,
            B = e.document,
            P = 0,
            W = 0,
            I = n(),
        ...
        try {
            Z.apply(G = et.call(B.childNodes), B.childNodes), G[B.childNodes.length].nodeType
        } catch (kt) {
            Z = {
        ...
        w = t.support = {}, C = t.isXML = function(e) {
            ...
            var t, n = e ? e.ownerDocument || e : B,
                r = n.defaultView;
            return n !== _ && 9 === n.nodeType && n.documentElement ? (_ = n, H = n.documentElement, q = !C(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
                L()
            ...
            }, M = [], F = [], (w.qsa = vt.test(n.querySelectorAll)) && (i(function(e) {
            ...
            })), (w.matchesSelector = vt.test($ = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && i(function(e) {
                w.disconnectedMatch = $.call(e, "div"), $.call(e, "[s!='']:x"), M.push("!=", st)
            }), F = F.length && new RegExp(F.join("|")), M = M.length && new RegExp(M.join("|")), t = vt.test(H.compareDocumentPosition), O = t || vt.test(H.contains) ? function(e, t) {
                ...
                return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === B && O(B, e) ? -1 : t === n || t.ownerDocument === B && O(B, t) ? 1 : A ? tt.call(A, e) - tt.call(A, t) : 0 : 4 & r ? -1 : 1)
            } : function(e, t) {
                if (e === t) return D = !0, 0;
                var r, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== _ && L(e), n = n.replace(dt, "='$1']"), !(!w.matchesSelector || !q || M && M.test(n) || F && F.test(n))) try {
                var r = $.call(e, n);
                if (r || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
            } catch (i) {}
            return t(n, _, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== _ && L(e), O(e, t)
        }, t.attr = function(e, t) {
    ...
    Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, it.extend({
        clone: function(e, t, n) {
            ...
            if (nt.html5Clone || it.isXMLDoc(e) || !Ot.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Qt.innerHTML = e.outerHTML, Qt.removeChild(o = Qt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || it.isXMLDoc(e)))
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                for (s = s || f.appendChild(t.createElement("div")), l = (Pt.exec(o) || ["", ""])[1].toLowerCase(), c = Yt[l] || Yt._default, s.innerHTML = c[1] + o.replace(Bt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        ...
        html: function(e) {
            return At(this, function(e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Ot.test(e) || !nt.leadingWhitespace && Rt.test(e) || Yt[(Pt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Bt, "<$1></$2>");
                    try {
    ...
    it.fn.extend({
        ...
        attr: function(e, t, n) {
            var r, i, o = e.nodeType;
            if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === kt ? it.prop(e, t, n) : (1 === o && it.isXMLDoc(e) || (t = t.toLowerCase(), r = it.attrHooks[t] || (it.expr.match.bool.test(t) ? kn : Tn)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = it.find.attr(e, t), null == i ? void 0 : i) : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void it.removeAttr(e, t))
        },
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(bt);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = it.propFix[n] || n, it.expr.match.bool.test(n) ? Sn && Nn || !En.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""), e.removeAttribute(Nn ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, n) {
            return t === !1 ? it.removeAttr(e, n) : Sn && Nn || !En.test(n) ? e.setAttribute(!Nn && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0, n
        }
    ...
    qn = Wn.exec(Fn.toLowerCase()) || [], it.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || Fn) + "").replace(Mn, "").replace(Pn, qn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (r = Wn.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === qn[1] && r[2] === qn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (qn[3] || ("http:" === qn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), B(In, d, t, w), 2 === b) return w;
            l = d.global, l && 0 === it.active++ && it.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Bn.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (_n.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = $n.test(o) ? o.replace($n, "$1_=" + Ln++) : o + (_n.test(o) ? "&" : "?") + "_=" + Ln++)), d.ifModified && (it.lastModified[o] && w.setRequestHeader("If-Modified-Since", it.lastModified[o]), it.etag[o] && w.setRequestHeader("If-None-Match", it.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Xn + "; q=0.01" : "") : d.accepts["*"]);
    ...
    it.offset = {
        ...
        offset: function(e) {
            ...
            var t, n, r = {
                ...
                i = this[0],
                o = i && i.ownerDocument;
            if (o) return t = o.documentElement, it.contains(t, i) ? (typeof i.getBoundingClientRect !== kt && (r = i.getBoundingClientRect()), n = V(o), {
...
$(document).ready(function() {
    var e = {
        ...
        n = {};
    swfobject.embedSWF("http://www.rdio.com/api/swf/", "apiswf", 1, 1, "9.0.0", "expressInstall.swf", e, t, n), $("#play").click(function() {
        ...
        lyrics = " ", apiswf.rdio_next()
    })
});
var callback_object = {};
callback_object.ready = function(e) {
        apiswf = $("#apiswf").get(0), apiswf.rdio_startFrequencyAnalyzer({
            frequencies: "10-band",
            period: 100
        }), null == e ? $("#nobody").show() : e.isSubscriber ? $("#subscriber").show() : e.isTrial ? $("#trial").show() : e.isFree ? ($("#remaining").text(e.freeRemaining), $("#free").show()) : $("#nobody").show(), console.log(e)
    }, callback_object.freeRemainingChanged = function(e) {
        $("#remaining").text(e)
    }, callback_object.playStateChanged = function(e) {
        $("#playState").text(e)
    }, callback_object.playingTrackChanged = function(e) {
        null != e && ($("#track").text(e.name), $("#album").text(e.album), $("#artist").text(e.artist), $("#art").attr("src", e.icon), lyrics = " ", console.log(e), artBackground = function() {
            var e = $("#album").html();
            console.log("album name: "), console.log(e), $.ajax("/album", {
                type: "POST",
                data: {
                    album: e
                },
                dataType: "json",
                success: function(e) {
                    album = e, $("#lyrics").html(" "), lyrics = " ";
                    var t = "rgba(";
                    r = album.r, g = album.g, b = album.b, a = album.a;
                    var n = t + r + ", " + g + ", " + b + ", " + a + ")";
                    console.log(n), $("body").css("backgroundColor", n), console.log(t), console.log("ajax album: "), console.log(e)
                },
                error: function() {
                    console.log("ALBUM ERROR")
                }
            })
        }, artBackground(), updateUrl = function() {
            var e = $("#artist").html(),
                t = $("#track").html(),
                n = "track.search";
            console.log("working?"), console.log(e), $.ajax("/lyrics", {
                type: "POST",
                data: {
                    artist: e,
                    track: t,
    ...
    }, callback_object.playingSourceChanged = function() {}, callback_object.volumeChanged = function() {}, callback_object.muteChanged = function() {}, callback_object.positionChanged = function(e) {
        console.log(e), $("#position").text(e), lyrics.forEach(function() {
            for (var t = 0; lyrics[t].time < e + 1; t++) console.log(lyrics[t].lyrics), $("#lyrics").html(lyrics[t].lyrics)
        })
    }, callback_object.queueChanged = function() {}, callback_object.shuffleChanged = function() {}, callback_object.repeatChanged = function() {}, callback_object.playingSomewhereElse = function() {}, callback_object.updateFrequencyData = function(e) {
        var t = e.split(","),
            n = ["#ff0000", "#ff7700", "#f6fa00", "#24fb02", "#0612fa", "#5f0cb3"],
            r = Math.floor(Math.random() * n.length);
        $("#freq div").each(function(e) {
            $(this).width(parseInt(500 * parseFloat(t[e])))
        }), $(".band").each(function() {
            $("#freq").css("background-color", n[r]), $(this).css("background-color", n[r])
        })
    },
    function() {}.call(this),
    function() {}.call(this),
